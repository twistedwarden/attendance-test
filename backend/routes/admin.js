    ...
    try {
        ...
        let query = `
            SELECT 
                ...
                MAX(er.ReviewID) as reviewId,
                MAX(er.Status) as reviewStatus,
                MAX(er.ReviewDate) as reviewDate,
                MAX(er.DeclineReason) as declineReason,
                MAX(er.Notes) as reviewNotes,
                MAX(er.ReviewedByUserID) as reviewedBy,
                MAX(ua.Username) as reviewedByUsername,
